...
public partial class View_GiayMoiHop : System.Web.UI.Page
{
    ...
    protected void ListPager_PreRender(object sender, EventArgs e)
    {
        ...
        List<BaiViet> listBV = BaiViet.LayTheoModuleAll("15");
    ...
    protected string ShowArticleCat(object sender, string column)
    {
        ...
        switch (column)
        {
            ...
            case "ArticleCatDuongDan":
                return "/3/bai-viet-tv/" + Helper.RejectMarks(baiviet.TieuDe_Vn) + "-" + baiviet.ID + ".html";

...
public partial class View_Categorys : System.Web.UI.Page
{
    ...
    private void PopulateControls()
    {
        ...
        if (theLoaiID != "")
        {
            ...
            else
            {
                ...
                List<BaiViet> list = BaiViet.LayTheoTheLoai(theLoaiID, trang, out howManyPages);
                ...
                firstPageUrl = Link.Categorys(theLoai.TieuDe_Vn, theLoaiID);
                pagerFormat = Link.Categorys(theLoai.TieuDe_Vn, theLoaiID, "{0}");
            }
        }

...
<table class="list">
    ...
    <tr class="eventop">
        <td class="titlemax">
            Tổng số giỏ hàng đang mua sắm tại website
        </td>
        <td class="link">
            <asp:Label ID="lbshopping" runat="server" Text="0"></asp:Label>
        </td>
    </tr>
    <tr class="evenbottom">
        <td class="titlemax">
            Tổng hóa đơn hàng đang đợi xử lý
        </td>
        <td class="link">
    ...
    <tr class="evenbottom">
        <td class="titlemax">
            Tổng hóa đơn hàng đã được duyệt
        </td>
        <td class="link">

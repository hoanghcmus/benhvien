                    ...
                    <div class="toolbar">
                        <table class="Edit">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtTenVn"
                                        CssClass="red">(Nhập tên)</asp:RequiredFieldValidator>
                                    <asp:CustomValidator ID="valTenVn" ControlToValidate="txtTenVn" Text="(Tên < 100 ký tự)"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtmoTaVn"
                                        CssClass="red">(Nhập tên)</asp:RequiredFieldValidator>

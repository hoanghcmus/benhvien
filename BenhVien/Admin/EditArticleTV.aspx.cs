...
public partial class Admin_EditArticleTV : System.Web.UI.Page
{
    ...
    private void LoadLoaiMenu()
    {
        ...
        ddlLoaiMenu.DataSource = TheLoai.LayTheoModule(lbModuleID.Text);
    ...
    private void LoadTheLoai()
    {
        ...
        List<TheLoai> list = TheLoai.LayTheoModule(lbModuleID.Text);

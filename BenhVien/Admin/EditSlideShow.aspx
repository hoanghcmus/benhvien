                    ...
                    <div class="toolbar">
                        <table class="Edit">
                            ...
                            <%--<tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlLoadMenu" AppendDataBoundItems="true" AutoPostBack="true"
                                        ...
                                        <asp:ListItem Value="1"> Hiển thị ở trang ngoài </asp:ListItem>
                                        <asp:ListItem Value="2"> Hiển thị ở trang trong </asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>--%>
                            <tr>
                            ...
                            <tr class="text">
                                ...
                                <td>
                                    <p>
                                        Ảnh hiển thị đẹp nhất ở kích thước 984x460
                                    </p>

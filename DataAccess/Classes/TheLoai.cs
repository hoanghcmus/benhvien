        ...
        public static int ThemYesIDParent(TheLoai theLoai)
        {
            try
            {
                object rs = DataProvider.Instance.ExecuteNonQueryWithOutput("@ID", "TheLoai_ThemYesIDParent",
                    theLoai.ID, theLoai.TieuDe_Vn, theLoai.MoTa_Vn, theLoai.HinhAnh, theLoai.IDParent, theLoai.IDLoaiMenu, theLoai.IDModule, theLoai.DuongDan_Vn, theLoai.ViTri, theLoai.Footer);
        ...
        public static int ThemNoIDParent(TheLoai theLoai)
        {
            try
            {
                object rs = DataProvider.Instance.ExecuteNonQueryWithOutput("@ID", "TheLoai_ThemNoIDParent",
                    theLoai.ID, theLoai.TieuDe_Vn, theLoai.MoTa_Vn, theLoai.HinhAnh, theLoai.IDLoaiMenu, theLoai.IDModule, theLoai.DuongDan_Vn, theLoai.ViTri, theLoai.Footer);
                return Convert.ToInt32(rs);
            }
            catch
            { return 0; }
        ...
        public static int SuaNoParent(TheLoai theLoai)
        {
            try
            {
                object rs = DataProvider.Instance.ExecuteNonQuery("TheLoai_SuaNoParent", ConvertType.ToInt32(theLoai.ID)
                    , theLoai.TieuDe_Vn, theLoai.MoTa_Vn
                    , theLoai.HinhAnh, theLoai.IDLoaiMenu, theLoai.IDModule, theLoai.DuongDan_Vn, theLoai.ViTri, theLoai.Footer);
                return Convert.ToInt32(rs);
            }
            catch
            { return 0; }
        ...
        public static int SuaYesParent(TheLoai theLoai)
        {
            try
            {
                object rs = DataProvider.Instance.ExecuteNonQuery("TheLoai_SuaYesParent", ConvertType.ToInt32(theLoai.ID)
                    , theLoai.TieuDe_Vn, theLoai.MoTa_Vn
                    , theLoai.HinhAnh, theLoai.IDParent, theLoai.IDLoaiMenu, theLoai.IDModule, theLoai.DuongDan_Vn
                    , theLoai.ViTri, theLoai.Footer);
                return Convert.ToInt32(rs);
            }
            catch
            { return 0; }
